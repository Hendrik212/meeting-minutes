...
export class Analytics {
  ...
  static async track(eventName: string, properties?: AnalyticsProperties): Promise<void> {
    ...
    try {
      await platformInvoke('track_event', { eventName, properties });
    } catch (error) {
  ...
  static async identify(userId: string, properties?: AnalyticsProperties): Promise<void> {
    ...
    try {
      await platformInvoke('identify_user', { userId, properties });
      this.currentUserId = userId;
    } catch (error) {
  ...
  static async isSessionActive(): Promise<boolean> {
    ...
    try {
      return await platformInvoke('is_analytics_session_active');
    } catch (error) {
  ...
  static async trackMeetingStarted(meetingId: string, meetingTitle: string): Promise<void> {
    ...
    try {
      await platformInvoke('track_meeting_started', { meetingId, meetingTitle });
    } catch (error) {
  ...
  static async trackRecordingStarted(meetingId: string): Promise<void> {
    ...
    try {
      await platformInvoke('track_recording_started', { meetingId });
    } catch (error) {
  ...
  static async trackRecordingStopped(meetingId: string, durationSeconds?: number): Promise<void> {
    ...
    try {
      await platformInvoke('track_recording_stopped', { meetingId, durationSeconds });
    } catch (error) {
  ...
  static async trackMeetingDeleted(meetingId: string): Promise<void> {
    ...
    try {
      await platformInvoke('track_meeting_deleted', { meetingId });
    } catch (error) {
  ...
  static async trackSettingsChanged(settingType: string, newValue: string): Promise<void> {
    ...
    try {
      await platformInvoke('track_settings_changed', { settingType, newValue });
    } catch (error) {
  ...
  static async trackFeatureUsed(featureName: string): Promise<void> {
    ...
    try {
      await platformInvoke('track_feature_used', { featureName });
    } catch (error) {
  ...
  static async trackSummaryGenerationCompleted(
    ...
    try {
      ...
      await platformInvoke('track_summary_generation_completed', {
        modelProvider,
        modelName,
        success,
        durationSeconds,
  ...
  static async trackSummaryRegenerated(modelProvider: string, modelName: string) {
    ...
    try {
      ...
      await platformInvoke('track_summary_regenerated', {
        modelProvider,
        modelName
      });
  ...
  static async trackModelChanged(oldProvider: string, oldModel: string, newProvider: string, newModel: string) {
    ...
    try {
      ...
      await platformInvoke('track_model_changed', {
        oldProvider,
        oldModel,
        newProvider,
        newModel
  ...
  static async trackCustomPromptUsed(promptLength: number) {
    ...
    try {
      ...
      await platformInvoke('track_custom_prompt_used', {
        promptLength
      });
