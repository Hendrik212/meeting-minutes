...
export function ModelSettingsModal({
  ...
  const fetchOllamaModels = async (silent = false) => {
    ...
    try {
      ...
      const modelList = (await platformInvoke('get_ollama_models', { endpoint })) as OllamaModel[];
      setModels(modelList);
  ...
  const loadOpenRouterModels = async () => {
    ...
    try {
      ...
      setOpenRouterError('');
      const data = (await platformInvoke('get_openrouter_models')) as OpenRouterModel[];
  ...
  const handleSave = async () => {
    ...
    // try {
    //   await platformInvoke('api_save_auto_generate_setting', { enabled: autoGenerateEnabled });
  ...
  const downloadRecommendedModel = async () => {
    ...
    try {
      ...
      await platformInvoke('pull_ollama_model', {
